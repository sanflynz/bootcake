...
<div class="row">
    <div class="col-xs-12">
        ...
        <?= $this->Html->link(__('<i class="fa fa-plus"></i>'), ['action' => 'add'], ['class' => 'btn btn-primary', 'style' => 'width: 50px;', 'title' => 'New <%= $singularHumanName %>', 'escape' => false]) ?> &nbsp;&nbsp;<br>
        <br>
    ...
    %>
                    <td class="actions">
                        <?= $this->Html->link(__('<i class="fa fa-eye"></i>'), ['action' => 'view', <%= $pk %>], ['class' => 'btn btn-default', 'style' => 'width: 30px;', 'title' => 'View']) ?>
                        <?= $this->Html->link(__('<i class="fa fa-pencil"></i>'), ['action' => 'edit', <%= $pk %>], ['class' => 'btn btn-default', 'style' => 'width: 30px;', 'title' => 'Edit']) ?>
                        <?= $this->Form->postLink(__('<i class="fa fa-minus"></i>'), ['action' => 'delete', <%= $pk %>], ['confirm' => __('Are you sure you want to delete # {0}?', <%= $pk %>), 'class' => 'btn btn-danger', 'style' => 'width: 30px;', 'title' => 'Delete']) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
